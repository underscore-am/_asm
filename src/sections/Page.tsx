...
import { compile, registerNameToBinary, run } from "underscore-asm";
...
export function Page() {
  ...
  function refreshAddresses(vm: VM, result?: InstructionResult) {
    ...
    const instruction = vm.registers[registerNameToBinary.ip!];
    const line = vm.maps.get(instruction);
    ...
    e()!.setModelMarkers(model!, "myOwner", next);
  }
  ...
  return (
    ...
    >
      <Editor
        ...
        shouldDisable={() => instructionResult()?.shouldHalt ?? false}
        ref={monacoContainer}
      />
      <Ram
        registers={registers}
